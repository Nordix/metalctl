...
// deployProviderComponentCmd represents the deployProviderComponent command
var deployProviderComponentCmd = &cobra.Command{
...
func init() {
	deployCmd.AddCommand(deployProviderComponentCmd)
}
